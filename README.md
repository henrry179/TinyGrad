...
<p align="center">
  <img src="https://user-images.githubusercontent.com/26833451/149516660-0a099ab2-93a0-4e35-91f5-4dffde8330d6.gif" width="600" alt="TinyGrad Logo Animation">
</p>
...
| 任务编号 | 简短描述 | 类型 | 奖金 | 进度 |
| :--- | :--- | :--- | :--- | :--- |
| 06-08 | 匹配引擎速度优化 (2x/4x/8x提升) | 速度 | $1,000 | ⏳ 待开始 |
| 14 | WebGPU export_model 实现 | 重构 | $2,000 | ⏳ 待开始 |
| 13 | 训练 RetinaNet (MLPerf提交可获双倍奖金) | MLPerf | $1,000 | ⏳ 待开始 |
| 17 | 多机分布式训练扩展性优化 | 功能 | $1,000 | ⏳ 待开始 |
...
| 任务编号 | 简短描述 | 类型 | 奖金 | 进度 |
| :--- | :--- | :--- | :--- | :--- |
| 03 | beautiful_mnist_torch 使用 torch.compile | Torch | $300 | ⏳ 待开始 |
| 04 | gpt-fast 在 AMD 后端性能优化 | Torch | $400 | ⏳ 待开始 |
| 05 | 多 GPU 训练在 tiny torch 后端工作 | Torch | $500 | ⏳ 待开始 |
| 09 | NVIDIA 张量核心 FPR 支持 | 功能 | $300 | ⏳ 待开始 |
| 10 | AMD LLVM BERT MLPerf 性能优化 | 功能 | $250 | ⏳ 待开始 |
| 12 | Apple M3 Max OLMoE 性能优化 | 升级 | $300 | ⏳ 待开始 |
| 16 | Llama 4 Scout 在 tinybox 上性能目标 | 功能 | $500 | ⏳ 待开始 |
...
| 任务编号 | 简短描述 | 类型 | 奖金 | 进度 |
| :--- | :--- | :--- | :--- | :--- |
| 01 | CPU操作迁移到其他设备 | Torch | $200 | ⏳ 待开始 |
| 02 | hlb-CIFAR10 在 Torch 后端支持 | Torch | $200 | ⏳ 待开始 |
| 11 | Z3索引验证工具 | 功能 | $300 | ⏳ 待开始 |
| 15 | CPU缓冲区GC修复 | Bug 修复 | $200 | ⏳ 待开始 |
| 18 | RDNA4 张量核心优化 | 功能 | $150 | ⏳ 待开始 |
| 19 | CPU图 Clang/LLVM 兼容性 | 功能 | $200 | ⏳ 待开始 |
| 20 | RTX 5090 NV 后端支持 | 功能 | $300 | ⏳ 待开始 |
...
| 任务编号 | 简短描述 | 类型 | 奖金 | 进度 |
| :--- | :--- | :--- | :--- | :--- |
| 21 | 修复 AvgPool3D 线性化器 | Bug 修复 | $200 | ⏳ 待开始 |
| 22 | 修复线性化器失败案例53 | Bug 修复 | $100 | ⏳ 待开始 |
| 23 | 修复数据并行 ResNet 元数据问题 | Bug 修复 | $100 | ⏳ 待开始 |
...
<p align="center">
  <img src="https://user-images.githubusercontent.com/26833451/149516660-0a099ab2-93a0-4e35-91f5-4dffde8330d6.gif" width="600" alt="Development Workflow">
</p>
...
<p align="center">
  <a href="https://github.com/henrry179/TinyGrad/issues">
    <img src="https://img.shields.io/github/issues/henrry179/TinyGrad?style=for-the-badge&color=blue" alt="GitHub Issues">
  </a>
  <a href="https://github.com/henrry179/TinyGrad/pulls">
    <img src="https://img.shields.io/github/issues-pr/henrry179/TinyGrad?style=for-the-badge&color=blue" alt="GitHub Pull Requests">
  </a>
  <a href="https://github.com/henrry179/TinyGrad/graphs/contributors">
    <img src="https://img.shields.io/github/contributors/henrry179/TinyGrad?style=for-the-badge&color=blue" alt="GitHub Contributors">
  </a>
</p>
...
<p align="center">
  <img src="https://user-images.githubusercontent.com/26833451/149516660-0a099ab2-93a0-4e35-91f5-4dffde8330d6.gif" width="300" alt="Join Us">
</p>
...
<p align="center">
  <img src="https://img.shields.io/github/last-commit/henrry179/TinyGrad?style=flat-square" alt="GitHub Last Commit">
  <img src="https://img.shields.io/github/languages/code-size/henrry179/TinyGrad?style=flat-square" alt="GitHub Code Size">
  <img src="https://img.shields.io/github/license/henrry179/TinyGrad?style=flat-square" alt="GitHub License">
</p>
